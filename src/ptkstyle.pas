...
type
  ...
  public
    ...
    function GetNamedColorRGB(col : TptkColor) : TptkColor;
    function GetNamedFontDesc(afontid : string) : string;
    function CreateNamedFontx(afontid : string) : TptkFont;
  public
...
procedure DrawButtonFace(canvas : TptkCanvas; x,y,w,h : TptkCoord);
procedure DrawControlFrame(canvas : TptkCanvas; x, y, w, h : TptkCoord);
procedure DrawDirectionArrow(canvas : TptkCanvas; x,y,w,h : TptkCoord; direction : integer);
...
begin
  ...
  DefaultFont := ptkGetFont(GetNamedFontDesc('Label1'));
  
  MenuFont := ptkGetFont(GetNamedFontDesc('Menu'));
  MenuAccelFont := ptkGetFont(GetNamedFontDesc('MenuAccel'));
  MenuDisabledFont := ptkGetFont(GetNamedFontDesc('MenuDisabled'));
end;

function TGfxStyle.GetNamedColorRGB(col : TptkColor) : TptkColor;
begin
...
function TGfxStyle.CreateNamedFontx(afontid: string): TptkFont;
begin
  result := ptkGetFont(GetNamedFontDesc(afontid));
end;
