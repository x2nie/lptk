...
function TwgMemo.GetFontDesc: string;
begin
...
procedure TwgMemo.SetFontDesc(const AValue: string);
begin
  FFont.Free;
...
procedure TwgMemo.HandleKeyChar(var keycode: word; var shiftstate: word; var consumed : boolean);
var
  prevval : WideString;
  s, ls, ls2 : WideString;
  cx : integer;
...
procedure TwgMemo.HandleLMouseDown(x, y : integer; shiftstate : word);
var
  n : integer;
  cpx : integer;
  cp : integer;
