...
uses
  Classes, SysUtils, pgf_defs, pgf_main, pgf_utils, pgf_Widget, wgScrollBar;

type

  { TwgListBox }

  TwgListBox = class(TpgfWidget)
  private
    FPopupFrame: boolean;
...
procedure TwgListBox.SetBackgroundColor(color : TpgfColor);
begin
  FBackgroundColor := color;
  RePaint;
end;

procedure TwgListBox.HandleShow;
begin
...
function TwgListBox.ListHeight: TpgfCoord;
begin
  result := height - (2*FMargin);
end;

function TwgListBox.ScrollBarWidth: TpgfCoord;
begin
...
procedure TwgListBox.HandlePaint;
var
  n : integer;
  r : TpgfRect;
begin
...
procedure TwgListBox.DrawItem(num: integer; rect: TpgfRect; flags: integer);
var
  s : WideString;
begin
...
procedure TwgListBox.HandleLMouseDown(x, y: integer; shiftstate: word);
begin
...
procedure TwgListBox.HandleLMouseUp(x, y: integer; shiftstate: word);
begin
...
procedure TwgListBox.HandleRMouseDown(x, y: integer; shiftstate: word);
begin
...
procedure TwgListBox.HandleRMouseUp(x, y: integer; shiftstate: word);
begin
