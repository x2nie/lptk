...
function CreateEdit(AOwner : TComponent; x, y, w, h : TpgfCoord) : TwgEdit;
...
procedure TwgEdit.HandleKeyChar(var keycode: word; var shiftstate: word; var consumed : boolean);
var
  prevval : WideString;
  s : WideString;
...
procedure TwgEdit.HandleLMouseDown(x, y : integer; shiftstate : word);
var
  s : WideString;
  n : integer;
  cpx : integer;
